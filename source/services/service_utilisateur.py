...
class ServiceUtilisateur:
    ...
    def creer_compte_anonyme(self):
        ...
        nouvel_utilisateur_invite = self.utilisateur_dao.create_compte(
            utilisateur_invite
        )
    ...
    def trouver_utilisateur_par_nom(self, nom, prenom):
        try:
            ...
            if eleve is not None:
                ...
                raise UtilisateurInexistantError(
                    f"Aucun utilisateur trouvé avec le nom '{nom}' et le prénom '{prenom}'."
                )
        except UtilisateurInexistantError as e:
            print(
                f"Une erreur s'est produite lors de la recherche de l'utilisateur : {e}"
            )
    ...
    def maj_pseudo(self, id_utilisateur, nouveau_pseudo):
        try:
            ...
            return self.utilisateur_dao.update_utilisateur_pseudo(
                id_utilisateur, nouveau_pseudo
            )
