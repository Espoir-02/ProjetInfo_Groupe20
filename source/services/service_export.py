    ...
    def exporter_donnees( id_stage, chemin_fichier_sortie):
        ...
        try:
            ...
            with open(chemin_fichier_sortie, 'w', encoding='utf-8') as fichier_sortie:
                ...
                fichier_sortie.write(f"Date de publication: {stage['date_publication']}\n")
        ...
        try:
            with open(chemin_fichier_sortie, 'w', encoding='utf-8') as fichier_sortie:
                ...
                for envie in liste_envies:
                    id_stage, titre, lien, domaine = envie["id_stage"], envie["titre"], envie["lien"], envie["domaine"]
        ...
        try:
            with open(chemin_fichier_sortie, 'w', encoding='utf-8') as fichier_sortie:
                ...
                for historique in historique:
                    id_stage, titre, lien, domaine = historique["id_stage"], historique["titre"], historique["lien"], historique["domaine"]
        ...
        try:
            with open(chemin_fichier_sortie, 'w', encoding='utf-8') as fichier_sortie:
                ...
                for suggestion in suggestions:
                    id_stage, titre, lien, domaine, id_professeur = suggestion["id_stage"], suggestion["titre"], suggestion["lien"], suggestion["domaine"], suggestion["id_professeur"]

                    ligne = f"{id_stage}; {titre}; {lien}; {domaine}; {id_professeur}"
                    fichier_sortie.write(f"{ligne}\n")

                print("****Exportation de la liste de suggestions réussie! Veuillez consulter vos fichiers")
        except Exception as e:
            print("Erreur lors de l'écriture dans le fichier :", str(e))
