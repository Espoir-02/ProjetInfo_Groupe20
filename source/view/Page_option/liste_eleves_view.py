...
class ListeElevesView:
    ...
    def ajout_eleve(self):
        try:
            ...
            if eleve is not None:
                ...
                self.liste_eleves_service.ajouter_eleve_a_liste_eleves(
                    id_eleve, self.id_professeur
                )
            else:
    ...
    def supprimer_eleve(self):
        while True:
            id_eleve = input(
                "Entrez l'ID de l'élève à supprimer (ou appuyez sur Entrée pour annuler) : "
            )
        ...
        self.liste_eleves_service.supprimer_eleve_de_liste_eleves(
            id_eleve, self.id_professeur
        )
        ...
        while True:
            ...
            if choix == "Consulter la liste des élèves":
                ...
                confirmation = inquirer.confirm(
                    message="Êtes-vous sûr de vouloir vider la liste des élèves?"
                )
                if confirmation:
