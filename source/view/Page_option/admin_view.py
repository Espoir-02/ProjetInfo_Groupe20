...
class AdminView:
    ...
    def supprimer_utilisateur(self):
        while True:
            id_utilisateur = input("Entrez l'ID de l'utilisateur à supprimer (ou appuyez sur Entrée pour annuler) : ")
            ...
            try:
                ...
                print("L'ID de l'utilisateur doit être un nombre entier. Veuillez réessayer.")
