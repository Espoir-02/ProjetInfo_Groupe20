...
class CreationCompte_view:
    ...
    def creer_compte(self, answers):
        ...
        if self.informations_obligatoires_remplies(nom, prenom, pseudo, mot_de_passe, type_utilisateur):
    ...
    def informations_obligatoires_remplies(self, nom, prenom, pseudo, mot_de_passe, type_utilisateur):
